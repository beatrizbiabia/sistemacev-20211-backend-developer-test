...
1. Please use one of the following languages/frameworks: *Java 8+ with EJB and JBoss (wildfly 15+)*. If you want to code some View, please use JSF, Primefaces, but it's not necessary;
...
Fork this repo and send us a pull request when you think you are done. We will note you about deadline directly by email.

> What if I have a question?

Just create a new issue in this repo and we will respond and get back to you quickly or contact us by email.

> What's the best way to send my project?

Please send us clear instructions to run your project: like a Docker (docker-compose) commands and a gently Postman project to test your endpoints. We love Docker + Postman to run this environment. <3
